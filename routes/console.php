...
// Prune expired ephemeral telephony/webhook logs (weekly)
Schedule::command('app:cleanup-ephemeral-data --days=30')
    ->weekly()
...
// Automated Daily Database Backup (02:00 UTC)
...
// Prune expired/orphaned AWS S3 storage files older than 7 days (Sundays 03:00)
Schedule::command('storage:prune-orphans --days=7')
    ->sundays()
    ->at('03:00')
    ->name('weekly-storage-prune')
    ->withoutOverlapping()
    ->onOneServer();
