...
export default {
    ...
    theme: {
        extend: {
            ...
            // Growbridge Connect palette — brand/navy (#011B40), secondary/forest-green
            // (#064E3B), accent (#FEB51B), light-bg (#F1F5F9), text (#0F172A), muted (#64748B).
