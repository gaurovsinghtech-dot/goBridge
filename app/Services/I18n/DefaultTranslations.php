...
class DefaultTranslations
{
    ...
    private static function admin(): array
    {
        return [
            ...
            'admin.note_label' => 'Note',
            'admin.gateway_enable_desc' => 'Enable or disable this payment gateway for customer subscriptions.',
            'admin.stripe_pk_placeholder' => 'rzp_test_… / rzp_live_…',
            'admin.stripe_sk_placeholder' => 'Key Secret',
