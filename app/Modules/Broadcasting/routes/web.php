...
Route::middleware(['web', 'client-app'])->prefix('app/broadcasts')->name('client.')->group(function () {
    ...
    Route::post('/campaigns/ai-generate', [CampaignController::class, 'aiGenerate'])->name('campaigns.ai-generate');
    Route::post('/campaigns/ai-tone', [CampaignController::class, 'aiTone'])->name('campaigns.ai-tone');
