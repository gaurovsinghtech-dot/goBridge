...
class LaunchCampaignJob implements ShouldQueue
{
    ...
    {
        $audienceService = app(\App\Services\Campaigns\CampaignAudienceService::class);
        $analysis = $audienceService->analyzeAudienceSuppression(
        ...
        return $analysis['deliverable_ids'] ?? [];
    }
