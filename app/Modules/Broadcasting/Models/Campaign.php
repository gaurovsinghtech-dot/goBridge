...
class Campaign extends Model
{
    ...
    protected $fillable = [
        'workspace_id', 'name', 'channel', 'whatsapp_phone_number_id', 'channel_account_id',
        'audience_type', 'audience_ref', 'template_ref', 'payload_json', 'schedule_at',
        'timezone', 'status', 'totals_json', 'created_by', 'quiet_hours_enabled',
        'quiet_hours_start', 'quiet_hours_end', 'frequency_cap_days', 'frequency_cap_max',
        'requires_approval', 'approved_by', 'approved_at', 'replied_count',
        'estimated_cost', 'confirmation_required', 'confirmed_at',
    ];
    ...
    public function channelAccount(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
        return $this->belongsTo(\App\Modules\Shared\Models\ChannelAccount::class);
    }
