...
class ContactController extends Controller
{
    ...
    public function show(Request $request, Contact $contact): Response
    {
        ...
        $timeline = $timelineService->getTimeline($contact, $request->all());
        $journey = $timelineService->getJourneySummary($contact);
        $aiSummary = $timelineService->getAiCustomerSummary($contact);
