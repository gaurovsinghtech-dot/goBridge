...
Route::middleware(['web', 'client-app'])->prefix('app/inbox')->name('client.inbox.')->group(function () {
    ...
    // AI and Omnichannel Controls
    Route::post('/conversations/{conversation}/ai-mode', [InboxController::class, 'toggleAiMode'])->name('ai-mode');
    Route::post('/conversations/{conversation}/ai-generate-reply', [InboxController::class, 'aiGenerateReply'])->name('ai-generate-reply');
    Route::post('/conversations/{conversation}/ai-reply', [InboxController::class, 'aiReply'])->name('ai-reply');
    Route::post('/conversations/{conversation}/ai-summarize', [InboxController::class, 'aiSummarize'])->name('ai-summarize');
    Route::post('/conversations/{conversation}/ai-qualify-lead', [InboxController::class, 'aiQualifyLead'])->name('ai-qualify-lead');
    Route::post('/conversations/{conversation}/start-automation', [InboxController::class, 'startAutomation'])->name('start-automation');
    Route::post('/conversations/{conversation}/schedule-followup', [InboxController::class, 'scheduleFollowup'])->name('schedule-followup');
    Route::post('/conversations/{conversation}/add-tag', [InboxController::class, 'addTag'])->name('add-tag');
