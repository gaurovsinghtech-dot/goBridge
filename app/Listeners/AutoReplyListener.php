...
class AutoReplyListener
{
    ...
    private function process(MessageReceived $event): void
    {
        ...
        if ($handoffService->isHandoffRequested($body)) {
            $handoffService->executeHandoff($conversation, null, 'Customer requested human');
    ...
    {
        app(\App\Modules\Inbox\Services\HumanHandoffService::class)->executeHandoff($conversation, null, $reason);
    }
}
