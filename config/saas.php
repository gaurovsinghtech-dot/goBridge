...
return [
    ...
    */
    'app_name' => env('APP_NAME', 'Growbridge Connect'),
    'tagline' => env('SAAS_TAGLINE', 'Connect. Engage. Automate. Grow.'),
    'support_email' => env('SAAS_SUPPORT_EMAIL', env('MAIL_FROM_ADDRESS', 'support@growbridge.co.in')),
