...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function createSuperAdmin(array $attrs = []): AdminUser
    {
        ...
        $permKeys = [
            ...
            'view_clients', 'manage_clients', 'impersonate_clients',
    ...
    protected function createSuperAdminUser(array $attrs = []): AdminUser
    {
        return $this->createSuperAdmin($attrs);
    }
