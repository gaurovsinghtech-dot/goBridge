...
export default function Register({ plan_id = null, cycle = 'month' }) {
    ...
    return (
        <AuthLayout
            ...
            error={errors.name || errors.email || errors.password || errors.password_confirmation || errors.agree_terms}
        >
            <Head title="Sign Up · Growbridge Connect" />

            <form onSubmit={submit} className="space-y-3.5">
                {/* Full Name and Business Name Row */}
