    ...
    return (
        <ClientLayout title={t('webhook.title')}>
            ...
            <div className="space-y-6 max-w-5xl">
                <ApiConnectionsNav current="webhooks" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-neutral-900 dark:text-white">{t('webhook.endpoints_heading', 'Webhook Endpoints')}</h1>
                            <p className="text-xs text-neutral-500 dark:text-neutral-400">{t('webhook.endpoints_subtitle', 'Receive real-time HTTP POST events when messages, payments, or contacts update.')}</p>
                        </div>
                    </div>
                    {(
                        <button
                            onClick={() => setShowCreate(true)}
                            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-sm transition-all"
                        >
                            <Plus className="h-4 w-4" /> {t('webhook.add_endpoint', 'Add Endpoint')}
                        </button>
                    )}
                </div>
