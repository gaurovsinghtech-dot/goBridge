...
import { BookOpen, ChevronDown, ChevronRight, Key, ShieldCheck, Code2, ExternalLink } from 'lucide-react';
    ...
    return (
        <ClientLayout title={t('api.docs_title')}>
            ...
            <div className="space-y-6 max-w-5xl">
                <ApiConnectionsNav current="docs" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-neutral-900 dark:text-white">{t('api.rest_docs', 'REST API Reference')}</h1>
                            <p className="text-xs text-neutral-500 dark:text-neutral-400">
                                {t('api.base_url')}: <code className="font-mono text-emerald-600 dark:text-emerald-400">{window.location.origin}/api/v1</code>
                            </p>
                        </div>
                    </div>
                    <Link
                        href={route('client.api-tokens.index')}
                        className="inline-flex items-center gap-2 px-3.5 py-2 text-sm font-semibold bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 shadow-sm transition-all"
                    >
                        <Key className="h-4 w-4" /> {t('api.manage_tokens', 'API Keys')}
                    </Link>
                </div>
