...
<html lang="{{ str_replace('_', '-', $locale) }}" dir="{{ $htmlDir }}">
    <head>
        ...
        @else
            {{-- Official Growbridge Connect brand icon --}}
            <link rel="icon" type="image/png" href="/images/brand/logo-icon.png">
            <link rel="alternate icon" href="/images/brand/logo-icon.png" sizes="any">
